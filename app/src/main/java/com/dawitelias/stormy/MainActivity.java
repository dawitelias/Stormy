...
//        final double longitude = -122.423;
        ...
        if (gpsTracker.canGetLocation()) {
            ...
            adminArea = gpsTracker.getAdminArea(this);
            ...
            mLocationLabel.setText(locality + ", " + adminArea);
    ...
    private void getForecast(double lat, double lon) {
        String apiKey = "a5572d439675e5934cab7f3162665f81";
        ...
        if ( isNetworkAvailable() ) {
            ...
            // code executing in the background
...
//        mLocationLabel.setText(locality);
    ...
    // moving responsibility for handling exception
    ...
    private boolean isNetworkAvailable() {
        ...
        // if network is present and is connected
